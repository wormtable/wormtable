...
Combining wormtable's custom row format with Berkeley DB gives us a 
powerful platform for data storage and processing.
An important advantage
of this combination is the ability to index data. Wormtable supports
indexes over arbitary combinations of columns, along with a flexibile
system of `binning' of values in an index.
Indexes can often be used to avoid the cost of a full table scan, and 
can therefore make many operations much faster.
